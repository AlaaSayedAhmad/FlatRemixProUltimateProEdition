# Generated by Powerlevel10k configuration wizard on 2025-12-17 at 12:35 IST.
...
() {
 ...
 typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    status                  # علامة صح أو خطأ للأمر السابق
     py_finder               # <--- 🐍 كاشف البايثون الجديد (وضعناه هنا ليكون واضحاً)
    command_execution_time  # وقت تنفيذ الأمر
    background_jobs         # العمليات في الخلفية
    
    # --- Network & Hardware (مراقبة الشبكة والموارد) ---
    # ip                      # عنوان IP المحلي
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=79
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=79
  ...
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_BACKGROUND=60
  # Custom icon.
...
###[ virtualenv: python virtual environment (https://docs.python.org/3/library/venv.html) ]###
  ...
  # 3. الأيقونة: شعار بايثون الرسمي (بدلاً من الافتراضي)
  typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION=''
  
  # إعدادات إضافية لضبط العرض
...
##########[ nodenv: node.js version from nodenv ]##########
  # الخلفية: لون فيدورا الداكن (#241f31)
  typeset -g POWERLEVEL9K_NODENV_BACKGROUND='#241f31'
  # الخط: أخضر فاتح (76) ليبرز على الخلفية الداكنة
  typeset -g POWERLEVEL9K_NODENV_FOREGROUND=76
  ...
  # الخلفية: لون فيدورا الداكن (#241f31)
  typeset -g POWERLEVEL9K_NVM_BACKGROUND='#241f31'
  # الخط: أخضر فاتح (76)
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=76
  ...
  typeset -g POWERLEVEL9K_NODEENV_BACKGROUND='#241f31'
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND=76
...
#######################[ go_version: go version ]########################
  # الخلفية موحدة، الخط سماوي (Go Brand Color)
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND='#241f31'
  ...
  # الخلفية موحدة، الخط برتقالي (Rust Brand Color)
  typeset -g POWERLEVEL9K_RUST_VERSION_BACKGROUND='#241f31'
  typeset -g POWERLEVEL9K_RUST_VERSION_FOREGROUND=208
  
  typeset -g POWERLEVEL9K_RUST_VERSION_PROJECT_ONLY=true
  # تفعيل أيقونة Rust (السلطعون)
  typeset -g POWERLEVEL9K_RUST_VERSION_VISUAL_IDENTIFIER_EXPANSION=''

  ###############[ dotnet_version: .NET version ]################
  # الخلفية موحدة، الخط بنفسجي فاتح (.NET Brand Color)
  typeset -g POWERLEVEL9K_DOTNET_VERSION_BACKGROUND='#241f31'
  typeset -g POWERLEVEL9K_DOTNET_VERSION_FOREGROUND=135
  ...
  # الخلفية موحدة، الخط أزرق نيلي (PHP Brand Color)
  typeset -g POWERLEVEL9K_PHP_VERSION_BACKGROUND='#241f31'
  typeset -g POWERLEVEL9K_PHP_VERSION_FOREGROUND=147
  ...
  # الخلفية موحدة، الخط أحمر (Laravel Brand Color)
  typeset -g POWERLEVEL9K_LARAVEL_VERSION_BACKGROUND='#241f31'
  typeset -g POWERLEVEL9K_LARAVEL_VERSION_FOREGROUND=196
  # تفعيل أيقونة Laravel
  typeset -g POWERLEVEL9K_LARAVEL_VERSION_VISUAL_IDENTIFIER_EXPANSION=''

  #############[ rbenv: ruby version from rbenv ]##############
  # الخلفية موحدة، الخط أحمر ياقوتي (Ruby Brand Color)
  typeset -g POWERLEVEL9K_RBENV_BACKGROUND='#241f31'
  typeset -g POWERLEVEL9K_RBENV_FOREGROUND=196
  
  typeset -g POWERLEVEL9K_RBENV_SOURCES=(shell local global)
  typeset -g POWERLEVEL9K_RBENV_PROMPT_ALWAYS_SHOW=false
  typeset -g POWERLEVEL9K_RBENV_SHOW_SYSTEM=true
  # تفعيل أيقونة الجوهرة
  typeset -g POWERLEVEL9K_RBENV_VISUAL_IDENTIFIER_EXPANSION=''

  ####################[ java_version: java version ]####################
  # الخلفية موحدة، الخط برتقالي (Java Brand Color)
  typeset -g POWERLEVEL9K_JAVA_VERSION_BACKGROUND='#241f31'
  typeset -g POWERLEVEL9K_JAVA_VERSION_FOREGROUND=208
  
  typeset -g POWERLEVEL9K_JAVA_VERSION_PROJECT_ONLY=true
  typeset -g POWERLEVEL9K_JAVA_VERSION_FULL=false
  # تفعيل أيقونة كوب القهوة
  typeset -g POWERLEVEL9K_JAVA_VERSION_VISUAL_IDENTIFIER_EXPANSION=''

  ###[ package: name@version from package.json ]####
  # الخلفية موحدة، الخط أصفر (لتمييزه عن اللغات)
  typeset -g POWERLEVEL9K_PACKAGE_BACKGROUND='#241f31'
  typeset -g POWERLEVEL9K_PACKAGE_FOREGROUND=226
  
  # تفعيل أيقونة الصندوق
